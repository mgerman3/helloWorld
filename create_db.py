...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'mgerman', 'email': 'mgerman@terpmail.umd.edu', 'first_name': 'Michael', 'last_name': 'German',
         'password': generate_password_hash('michaelpw', method='sha256'), 'role': 'STUDENT'},
